 ...
 * [amph.yml](amph.yml)
     * Determines how your purl.obolibrary.org/obo/amph/ redirects will be handled
     ...
     * Paste in the contents of [amph.yml](amph.yml)
 ...
 * [amph.md](amph.md)
     ...
     * Paste in the contents of [amph.md](amph.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
